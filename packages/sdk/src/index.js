 ...
 *   BrowserSessionStore           — wraps window.sessionStorage (browser, tab-scoped)
 *   PersistentBrowserSessionStore — wraps window.localStorage (browser, survives tab close)
